...
# PUBLIC Route
# NAME About
# DESC About page for the blog application
# #########################################################
@app.route('/about')
def about():
...
def save_picture(form_picture):
    # Assign a random name to a file so it doesn't conflict with the directory files
    random_hex = secrets.token_hex(8)
    
    # Extract file extension from the form picture
    _, f_ext = os.path.splitext(form_picture.filename)
    picture_fn = random_hex + f_ext
    picture_path = os.path.join(app.root_path, 'static/profile_pics', picture_fn)

    # Resize the image to 125x125, save it as thumbnail basically
    output_size = (125, 125)
